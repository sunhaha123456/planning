...
CREATE TABLE `tb_dimension` (
  ...
  `dimension_member_data_type` tinyint(4) DEFAULT '0' COMMENT '维度类型',
  `dimension_member_flag` tinyint(4) DEFAULT '0' COMMENT '是否是维度成员',
  `dimension_name` varchar(255) DEFAULT NULL COMMENT '流程名称',
  PRIMARY KEY (`id`)
